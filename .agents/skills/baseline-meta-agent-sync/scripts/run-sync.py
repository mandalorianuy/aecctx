...
def _resolve_sync_cli(repo_root: Path):
    try:
        from agent_baseline.meta_agent_tooling import run_sync_meta_agent_repo_cli

        return run_sync_meta_agent_repo_cli
    except ImportError:
        pass
...
def main(argv: list[str] | None = None) -> int:
    ...
    runner = _resolve_sync_cli(repo_root)
    return runner(args)
