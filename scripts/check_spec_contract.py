...
def check_required_files() -> None:
    required = [
        ...
        ROOT / "schemas/v0.2/remote-provider-policy.schema.json",
        ROOT / "schemas/v0.2/source-bundle.schema.json",
        ...
        ROOT / "schemas/v0.2/rvt-provider-decision-v03.schema.json",
        ...
        ROOT / "conformance/v0.3/local-enforcement-corpus.json",
        ROOT / "conformance/v0.3/remote-provider-corpus.json",
        ROOT / "conformance/v0.3/ifc-corpus.json",
        ROOT / "conformance/v0.3/dxf-corpus.json",
        ...
        ROOT / "conformance/v0.3/rvt-provider-decision.json",
        ROOT / "conformance/v0.2/signing-corpus.json",
        ROOT / "conformance/v0.3/signing-corpus.json",
        ROOT / "scripts/check_rvt_blocked_conformance.py",
        ROOT / "scripts/check_local_enforcement_conformance.py",
        ROOT / "scripts/check_remote_provider_conformance.py",
        ROOT / "scripts/check_ifc_v03_conformance.py",
        ROOT / "scripts/check_dxf_v03_conformance.py",
        ROOT / "scripts/check_signing_conformance.py",
        ROOT / "scripts/check_signing_v03_conformance.py",
        ...
        ROOT / "fixtures/v0.3/local-providers/adversarial-cases.json",
        ROOT / "fixtures/v0.3/remote-providers/adversarial-cases.json",
        ROOT / "fixtures/v0.3/ifc/README.md",
        ROOT / "fixtures/v0.3/ifc/generate_fixtures.py",
        ROOT / "fixtures/v0.3/ifc/ifc4x3-curves-annotations-scaled.ifc",
        ROOT / "fixtures/v0.3/ifc/ifc4x3-degraded.ifc",
        ROOT / "fixtures/v0.3/ifc/ifc4x3-conflicted-georef.ifc",
        ...
        ROOT / "docs/specs/signing-v2-profile.md",
        ...
        ROOT / "conformance/v0.3/corpus.json",
        ...
        ROOT / "fixtures/v0.3/signing/README.md",
        ROOT / "fixtures/v0.3/signing/generate_fixtures.py",
        ROOT / "CHANGELOG.md",
