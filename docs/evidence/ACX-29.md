...
- Final exact-head CI also exposed a pre-existing ACX-28 gate defect: host text-mode newline translation made repeated DXF fixture regeneration nondeterministic on Windows. ACXD-038 corrected the shared owner with canonical in-memory serialization and an emulated Windows-newline regression; no DXF fixture or entry hash changed.
