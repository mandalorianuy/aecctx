...
| DWG | `unsupported`/opaque fallback; R2000/AC1015 LibreDWG profile remains a target until conformance passes | Planned experimental partial source graph plus explicitly converted DXF geometry through a reviewed GPL OCI provider | ACX-18 in progress |
