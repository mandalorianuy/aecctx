...
| AEC delivery quality gate | `unsupported` | Closed schemas and immutable public result/policy models exist; no strict parser, evaluator, CLI, corpus or public claim exists yet | ACX-21 in progress; Task 1 complete, Task 2 pending-next |
