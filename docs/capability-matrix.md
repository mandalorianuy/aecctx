...
| Package authenticity/signing | integrity only; authenticity `unsupported` | Accepted detached JWS/Ed25519 offline profile with distinct integrity, validity, identity, trust and authorization states; implementation/conformance not yet claimed | ACX-20 in progress |
