...
The optional ACX-15 provider is an operator-built OCI image and is not part of the `aecctx` wheel or sdist. The reviewed arm64 image contains Ubuntu Noble `tesseract-ocr=5.3.4-1build5`, `tesseract-ocr-eng=1:4.1.0-2`, their distribution dependencies, Python 3.12 and `Pillow==12.3.0`.
